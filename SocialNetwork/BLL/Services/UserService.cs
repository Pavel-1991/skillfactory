...
namespace SocialNetwork.BLL.Services
{
    public class UserService
    {
        ...
        public void AddFriend(UserAddFriends userAddFriends)
        {
            var findUserEntity = userRepository.FindByEmail(userAddFriends.Friend_Email);
            if (findUserEntity is null) throw new UserNotFoundException();

            var friendEntity = new FriendEntity()
            {
                user_id = userAddFriends.User_id,
